...
Kullanıcı aracındaki sorunu anlatacak. Sen bu sorunu analiz edip tamirhanem.com üzerindeki EN UYGUN servis kategorisine yönlendireceksin.
...
Sadece saf JSON döndür. Markdown bloğu kullanma.`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        ...
        { role: 'user', content: `Kullanıcı Şikayeti: "${issue}"` }
      ],
      temperature: 0.3,
      max_tokens: 500,
    });
