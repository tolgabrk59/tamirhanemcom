                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                            ...
                            <span className="text-sm font-semibold">Gerçek Piyasa Verileri</span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                                <span className="text-primary-200 text-xl font-bold">{reliabilityData.length}</span>
                                <span className="text-primary-200 text-sm">Marka Analizi</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                                <span className="text-green-300 text-xl font-bold">%100</span>
                                <span className="text-primary-200 text-sm">Yerel Veri</span>
                            </div>
                        </div>
                    </div>
                </div>
