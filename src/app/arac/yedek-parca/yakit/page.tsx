                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                            <PartIcon type="fuel" className="w-5 h-5" />
                            <span className="text-sm font-semibold">Yedek Parça Rehberi</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">Yakıt Sistemi Parçaları</h1>
                        <p className="text-xl text-primary-100 mb-6">
                            Motorunuza temiz ve doğru basınçta yakıt sağlayan sistem hakkında detaylı bilgi.
                        </p>
                    </div>
                </div>
            </section>
