...
export const commonProblemsData: CommonProblem[] = [
  // Mercedes Sorunları
  {
    ...
    description:
      'Havalı süspansiyon sisteminde yaşanan arızalar, özellikle W205 ve W204 serisinde sık görülür. Araç bir tarafa çökme, sürüş sertliği değişimi ve uyarı lambaları yanar.',
    symptoms: [
  ...
  },
  {
    ...
    brand: 'Mercedes',
    model: 'E-Serisi',
    title: 'Kam Mili Ayarlayıcı Arızası',
    description:
      'M272 ve M273 motorlarda yaygın görülen bir sorun. Motor çalışırken tıkırtı sesi ve performans kaybı yaşanır.',
    symptoms: [
  ...
  },
  {
    ...
    description:
      'Elektronik kontak sistemi arızası, aracın çalışmamasına neden olur. Direksiyon kilidi açılmaz veya anahtar tanınmaz.',
    symptoms: [
      'Anahtar tanınmıyor',
  ...
  // BMW Sorunları
  {
    ...
    description:
      'Değişken supap zamanlaması sistemi arızası. Özellikle E46 ve E90 modellerinde yaygın. Güç kaybı ve yakıt tüketimi artışına neden olur.',
    symptoms: [
  ...
  },
  {
    ...
    brand: 'BMW',
    model: '5 Serisi',
    title: 'Şanzıman Mekatronik Arızası',
    description:
      'Otomatik şanzıman kontrol ünitesi arızası. ZF şanzımanlı modellerde yaygın. Vites geçişlerinde sertlik ve hata kodları oluşur.',
    symptoms: [
  ...
  },
  {
    ...
    description:
      'Dört çeker sistemin transfer kutusu arızası. X5 E53 ve E70 modellerinde sık görülür.',
    symptoms: [
      '4x4 uyarı lambası',
      'Sürüşte titreşim',
  ...
  // Renault Sorunları
  {
    ...
    description:
      'EDC şanzımanda debriyaj aşınması ve mekatronik sorunları yaşayabilir. Özellikle Megane 3 ve 4 modellerinde yaygın.',
    symptoms: [
  ...
  },
  {
    ...
    brand: 'Renault',
    model: 'Clio',
    title: 'Gaz Kelebeği Arızası',
    description:
      'Elektronik gaz kelebeği sensör veya motor arızası. Clio 3 ve 4 modellerinde sık karşılaşılır.',
    symptoms: [
      'Rölantide düzensizlik',
      'Motor stop ediyor',
  ...
  },
  {
    ...
    title: 'Turbo Arızası',
    description:
      '1.5 dCi motorlarda turbo arızası yaygın görülür. Yağ kaçağı, türbin hasarı veya wastegate sorunları oluşabilir.',
    symptoms: [
      'Güç kaybı',
  ...
  // Volkswagen Sorunları
  {
    ...
    description:
      '7 ileri DSG şanzımanda mekatronik ünite ve debriyaj sorunları. Golf 6 ve 7 modellerinde görülür.',
    symptoms: [
  ...
  },
  {
    ...
    description:
      'TSI ve TFSI motorlarda zamanlama zinciri uzaması problemi. Motor çalışma sesinde değişiklik ve performans kaybı yaşanır.',
    symptoms: [
  ...
  // Ford Sorunları
  {
    ...
    title: 'DPF Tıkanması',
    description:
      'Özellikle kısa mesafe şehir içi kullanımda DPF tıkanması yaygın. Yağ ömrü hızla azalır ve DPF uyarı lambası yanar.',
    symptoms: [
      'DPF uyarı lambası',
      'Motor gücünde düşüş',
      'Yakıt tüketimi artışı',
  ...
  },
  {
    ...
    brand: 'Ford',
    model: 'Focus',
    title: 'Powershift Şanzıman Arızası',
    description:
      'Çift kavramalı Powershift şanzımanda vites geçişlerinde sarsıntı, sert vites değişimi ve yazılım sorunları.',
    symptoms: [
      'Vites geçişlerinde sarsıntı',
      'Kalkışta titreme',
      'Sert vites değişimi',
  ...
  },
  {
    ...
    description:
      'Egzoz gazı geri dönüşüm valfinde karbon birikimi. Motor performansında düşüş ve yakıt tüketiminde artış yaşanır.',
    symptoms: [
      'Motor gücünde kayıp',
      'Yakıt tüketimi artışı',
      'Siyah egzoz dumanı',
  ...
  // Audi Sorunları
  {
    ...
    description:
      '2.0 TFSI motorlarda aşırı yağ tüketimi sorunu. Piston segmanları ve silindir cidarı aşınmasından kaynaklanır.',
    symptoms: [
