...
export default function AIRecommendation() {
  ...
  // Markaları yükle (randevu sayfası ile aynı pattern)
  useEffect(() => {
  ...
  // Modelleri yükle (marka seçildiğinde)
  useEffect(() => {
  ...
  return (
    <section id="ai-asistan" className="relative py-10 md:py-20 scroll-mt-8">
        ...
        <AnimatedSection delay={0.1}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className={cn('', activeTab !== 'chat' && 'hidden md:block')}>
              <div className="glass-card p-5 md:p-6 flex flex-col h-full min-h-[400px] md:min-h-0">
                ...
                {/* Mesajlar */}
                <div className="flex-1 overflow-y-auto space-y-3 mb-4 max-h-[320px] pr-1 scrollbar-thin">
                  {chatMessages.length === 0 && (
