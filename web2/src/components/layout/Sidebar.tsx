    ...
    <>
      ...
      <aside className="hidden lg:flex fixed top-0 left-0 bottom-0 w-16 z-40 flex-col items-center justify-between py-4 bg-brand-500 shadow-lg">
        <div className="flex flex-col items-center gap-2">
          <span
            className="text-[#454545] text-xs font-bold"
          ...
          <Link
            href="/servis-ara"
            className="w-10 h-10 bg-[#454545] rounded-lg flex items-center justify-center hover:bg-[#555] transition-colors"
            title="Servis Ara"
          >
      ...
      {/* ═══════════════════════════════════════════
         ...
         ═══════════════════════════════════════════ */}
      <nav className="hidden lg:flex fixed bottom-0 left-16 right-0 h-14 bg-brand-500 z-40 items-center justify-between px-2 2xl:px-6 overflow-visible shadow-[0_-2px_10px_rgba(0,0,0,0.1)]">
        <div className="flex items-center gap-1 flex-1 min-w-0">
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'flex items-center gap-2 px-3 py-2 rounded-lg transition-all text-sm font-semibold font-display',
                  active
                    ? 'bg-brand-600/40 text-brand-950'
                    : 'text-brand-950/80 hover:bg-brand-600/20'
                )}
          ...
          <div className="h-6 w-px bg-brand-700/30 mx-2 shrink-0" />
            ...
            return (
              ...
              >
                <button
                  type="button"
                  className={cn(
                    'flex items-center gap-1.5 px-3 py-2 rounded-lg transition-all text-sm font-semibold font-display',
                    isOpen
                      ? 'bg-brand-600/40 text-brand-950'
                      : 'text-brand-950/80 hover:bg-brand-600/20'
                  )}
          ...
          <a
            ...
            className="flex items-center justify-center gap-1 2xl:gap-2 px-2 2xl:px-4 py-2 bg-[#128C7E] hover:bg-[#075E54] rounded-lg transition-all text-white font-semibold text-[11px] lg:text-xs 2xl:text-sm shadow-md hover:shadow-lg font-display shrink-0 whitespace-nowrap"
            title="WhatsApp Destek"
          >
            <svg className="w-4 h-4 2xl:w-5 2xl:h-5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            href="/hata-bildir"
            className="flex items-center justify-center gap-1 2xl:gap-2 px-2 2xl:px-4 py-2 bg-transparent border-2 border-brand-950/60 hover:border-brand-950 hover:bg-brand-950/10 rounded-lg transition-all text-brand-950 font-semibold text-[11px] lg:text-xs 2xl:text-sm font-display shrink-0 whitespace-nowrap"
            title="Hata Bildir"
          >
        ...
        <div className="flex items-center gap-2 shrink-0 ml-2">
          <a
            href="https://app.tamirhanem.com/login.html"
            className="flex items-center gap-1.5 px-3 py-2 text-brand-950/80 hover:bg-brand-600/20 rounded-lg transition-colors text-sm font-semibold font-display"
          >
            <User className="w-4 h-4" />
          ...
          <a
            href="https://app.tamirhanem.com/register.html"
            className="px-4 py-2 bg-brand-950 text-brand-500 rounded-lg font-semibold text-sm hover:bg-brand-900 transition-colors font-display"
          >
            Kayıt
          </a>
        </div>
