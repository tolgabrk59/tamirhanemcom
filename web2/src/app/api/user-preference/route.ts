...
const logger = createLogger('USER:PREFERENCE');
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${STRAPI}/user-preference`, {
    ...
    logger.error({ error: error.message }, 'User preference fetch failed');
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error({ error: error.message }, 'User preference update failed');
