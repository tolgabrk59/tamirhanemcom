...
export default function AracError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Arac error boundary caught:', error)
  }, [error])
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="glass-card mx-auto max-w-md p-8 text-center">
        ...
        <h2 className="mb-2 font-display text-xl font-bold text-th-fg">
          Arac bilgileri yuklenemedi
        </h2>
        <p className="mb-6 text-sm text-th-fg-sub">
          Arac verileri alinirken bir hata olustu. Lutfen tekrar deneyin.
        </p>
        <button
          onClick={reset}
